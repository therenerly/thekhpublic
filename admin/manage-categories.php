...
<td><a href="<?= ROOT_URL ?>admin/edit-category.php?id=<?= $category['id'] ?>" class="btn sm">កែសម្រួល</a></td>
<td><a href="<?= ROOT_URL ?>admin/delete-category.php?id=<?= $category['id'] ?>" class="btn sm danger">លុប</a></td>
</tr>
<?php endwhile ?>
</tbody>
</table>
<?php else : ?>
<div class="alert__message error"><?= "រកមិនឃើញប្រភេទទេ។" ?></div>
<?php endif ?>
</main>
</div>
</section>
