...
<td><?= $user['username'] ?></td>
<td><a href="<?= ROOT_URL ?>admin/edit-user.php?id=<?= $user['id'] ?>" class="btn sm">កែសម្រួល</a></td>
<td><a href="<?= ROOT_URL ?>admin/delete-user.php?id=<?= $user['id'] ?>" class="btn sm danger">លុប</a></td>
<td><?= $user['is_admin'] ? 'បាទ/ចាស' : 'ទេ' ?></td>
</tr>
<?php endwhile ?>
</tbody>
</table>
<?php else : ?>
<div class="alert__message error"><?= "រកមិនឃើញអ្នកប្រើប្រាស់ទេ។" ?></div>
<?php endif ?>
</main>
</div>
</section>
