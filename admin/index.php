...
<td><a href="<?= ROOT_URL ?>admin/edit-post.php?id=<?= $post['id'] ?>" class="btn sm">កែសម្រួល</a></td>
<td><a href="<?= ROOT_URL ?>admin/delete-post.php?id=<?= $post['id'] ?>" class="btn sm danger">លុប</a></td>
</tr>
<?php endwhile ?>
</tbody>
</table>
<?php else : ?>
<div class="alert__message error"><?= "រកមិនឃើញការបង្ហោះទេ។" ?></div>
<?php endif ?>
</main>
</div>
</section>
