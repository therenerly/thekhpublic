...
if (!$title) {
$_SESSION['edit-post'] = "មិន​អាច​ធ្វើ​បច្ចុប្បន្នភាព​ការ​បង្ហោះ។ ទិន្នន័យទម្រង់មិនត្រឹមត្រូវនៅលើទំព័រកែសម្រួល។";
} elseif (!$category_id) {
$_SESSION['edit-post'] = "មិន​អាច​ធ្វើ​បច្ចុប្បន្នភាព​ការ​បង្ហោះ។ ទិន្នន័យទម្រង់មិនត្រឹមត្រូវនៅលើទំព័រកែសម្រួល។";
} elseif (!$body) {
$_SESSION['edit-post'] = "មិន​អាច​ធ្វើ​បច្ចុប្បន្នភាព​ការ​បង្ហោះ។ ទិន្នន័យទម្រង់មិនត្រឹមត្រូវនៅលើទំព័រកែសម្រួល។";
...
$_SESSION['edit-post'] = "មិន​អាច​ធ្វើ​បច្ចុប្បន្នភាព​ប្រកាស។ ទំហំរូបភាពតូចធំពេក។ គួរតែតិចជាង 2mb";
}
} else {
$_SESSION['edit-post'] = "មិន​អាច​ធ្វើ​បច្ចុប្បន្នភាព​ប្រកាស។ រូបភាពតូចគួរតែជា png, jpg ឬ jpeg";
}
}
}
...
$_SESSION['edit-post-success'] = "បានធ្វើបច្ចុប្បន្នភាពសារបង្ហោះដោយជោគជ័យ";
}
}
